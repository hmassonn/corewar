...
/*   Updated: 2017/03/06 16:04:30 by hmassonn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cpu				*ft_fork(t_mars **mars,
	t_cpu *cpu, int *new_address, int mod);
...
void				ft_print_pid_color(t_mars **mars,
	int pid, t_cpu *cpu, int n);
